    ...
    <div className="relative mt-32 grid grid-cols-1 gap-24 md:grid-cols-3 md:gap-16 lg:gap-20 lg:max-w-[1060px] lg:mx-auto">
      {cards.map((card, index) => {
        ...
        return (
          <article
            key={card.title}
            className={`${reveal} group relative flex flex-col items-center gap-4 rounded-3xl bg-white px-8 pt-10 pb-6 shadow-card hover:shadow-card-hover hover:-translate-y-1.5 transition-[box-shadow,transform] duration-300`}
          >
            <div
