...
const coins = [
  { className: "top-[2%] right-[2%] w-[120px] lg:w-[141px]", rotate: -11, floatDelay: "0s", floatDuration: "4s" },
  { className: "top-[42%] right-[-2%] w-[80px] lg:w-[90px]", rotate: 11, floatDelay: "0.6s", floatDuration: "4.2s" },
  { className: "top-[64%] right-[3%] w-[120px] lg:w-[141px]", rotate: -11, floatDelay: "1.2s", floatDuration: "4.4s" },
  { className: "top-[18%] left-[-2%] w-[120px] lg:w-[141px]", rotate: 11, floatDelay: "0.3s", floatDuration: "4.1s" },
  { className: "top-[52%] left-[8%] w-[70px] lg:w-[78px]", rotate: -11, floatDelay: "0.9s", floatDuration: "4.3s" },
  { className: "top-[78%] left-[1%] w-[120px] lg:w-[141px]", rotate: 11, floatDelay: "1.5s", floatDuration: "4.5s" },
] as const;
    ...
    >
      ...
      <div className="relative mx-auto w-11/12 max-w-[1280px]">
        <header className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="anim-reveal-up text-[18px] leading-7 md:text-h5 font-bold font-sans text-brand-black">
          ...
          <p className="anim-reveal-up mt-2 max-w-[842px] text-s2 md:text-s1 tracking-[0.2px] font-sans text-brand-black">
        ...
        <div className="relative mt-32 grid grid-cols-1 gap-24 md:grid-cols-3 md:gap-12 lg:gap-12 xl:gap-20">
          {benefits.map((benefit) => (
            <article
              key={benefit.title}
              className={`${benefit.reveal} relative flex flex-col items-center justify-center gap-8 rounded-2xl bg-white px-8 py-6 shadow-card`}
            >
              <div
