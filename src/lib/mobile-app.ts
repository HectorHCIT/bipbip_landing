...
export const IOS_APP_ID =
  process.env.MOBILE_APP_IOS_ID ?? "1501865149";

/** Team ID + bundle identifier, e.g. `X35XBA523L.hn.cit.gccustomerapp`. */
export const IOS_BUNDLE_ID =
  process.env.MOBILE_APP_IOS_BUNDLE_ID ?? "X35XBA523L.hn.cit.gccustomerapp";

export const ANDROID_PACKAGE =
  process.env.MOBILE_APP_ANDROID_PACKAGE ?? "hn.cit.gccustomerapp";
